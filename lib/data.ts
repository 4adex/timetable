...
export const timetableData: TimeSlot[] = [
  ...
  },
  {
    ...
    tuesday: [],
    wednesday: [{ type: "L", code: "HSS-301", batch: "Batch 1", faculty: "Aparajita Singh", location: "APJ AKB-003" }],
    thursday: [],
    friday: [{ type: "T", code: "HSS-301", batch: "Batch 1", faculty: "Aparajita Singh", location: "APJ AKB-005" }],
  },
  {
    time: "10.00-10.55",
    monday: [{ type: "T", code: "MAT-106", batch: "Batch 1", faculty: "Chaman Kumar", location: "" }],
    tuesday: [],
    wednesday: [{ type: "T", code: "MAC-302", batch: "MA1, MA2", faculty: "Ram Jiwari", location: "" }],
    thursday: [],
    friday: [],
  },
  {
    time: "11.05-12.00",
    monday: [{ type: "L", code: "MAL-532", batch: "Batch 1", faculty: "Arunava Mandal", location: "GB-304" }],
    tuesday: [],
    wednesday: [{ type: "L", code: "MAL-532", batch: "Batch 1", faculty: "Arunava Mandal", location: "GB-304" }],
    thursday: [],
    friday: [{ type: "L", code: "MAL-532", batch: "Batch 1", faculty: "Arunava Mandal", location: "GB-304" }],
  },
  {
    time: "12.05-13.00",
    monday: [],
  ...
  },
  {
    ...
    wednesday: [{ type: "L", code: "MAT-106", batch: "Batch 1", faculty: "Chaman Kumar", location: "LH-02" }],
    thursday: [{ type: "L", code: "MAC-302", batch: "Batch 1", faculty: "Ram Jiwari", location: "GB-003" }],
    friday: [{ type: "L", code: "MAT-106", batch: "Batch 1", faculty: "Chaman Kumar", location: "LH-02" }],
  },
  {
    time: "15.00-15.55",
    monday: [],
    tuesday: [{ type: "L", code: "MAT-106", batch: "Batch 1", faculty: "Chaman Kumar", location: "LH-02" }],
    wednesday: [],
    thursday: [],
    friday: [],
  },
...
export const courseDetailsData: CourseDetail[] = [
  ...
  },
  {
    ...
    subBatch: "MA1",
    subjectArea: "PCC",
    subjectCodeSlot: "MAL-532 [C1]",
    subjectName: "Mathematical Cryptography",
    lectureHallNo: "GB-304",
    facultyName: "Arunava Mandal",
    credit: 4,
  },
  {
    semester: "Third Year - 2nd Sem (Spring)",
